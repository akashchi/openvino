...
nodes = {
    ...
    **regular_op_with_empty_data('identityN', {'op': 'IdentityN', 'type': None, 'data_types': [np.int32, np.float64],
                                               'name': 'my_identity'}),
    ...
    **regular_op_with_empty_data('identity1', {'op': 'Identity', 'type': None, 'data_type': np.float64,
